...
<img src="images/dog.0.jpg" align="right"> -->
  ...
  Cat            |  Dog
:--------------:|:--------:
![](figures/cat.7.jpg)  |  ![](figures/dog.5.jpg)
...
<div style="display:flex;align-items:center">
    <div>
        <h5> <a href='..'> Stephen Kiilu </a> </h5> <img src="images/cat.5.jpg" height= 7% width= 7%>
<div>
    <h5> <a href='.'> John Ndolo </a> </h5> <img src="images/dog.7.jpg" height= 7% width= 7%>
    
<div>
    <h5> <a href='.'> Redempta Manzi Assoumer </a> </h5> <img src="images/cat.4.jpg" height= 7% width= 7%>
